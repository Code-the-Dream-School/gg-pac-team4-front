...
const items = [
  { src: Music, alt: 'Music Icon', text: 'Music' },
  { src: Acting, alt: 'Acting Icon', text: 'Acting Skills' },
  { src: Storytelling, alt: 'Storytelling Icon', text: 'Storytelling' },
  { src: Arts, alt: 'Arts Icon', text: 'Arts' },
  { src: Photography, alt: 'Photography Icon', text: 'Photography' },
  { src: Games, alt: 'Games Icon', text: 'Games & Hobbies' },
  { src: Films, alt: 'Film Icon', text: 'Film Production' },
  { src: Animation, alt: 'Animation Icon', text: '3D & Animation' },
  { src: Handicraft, alt: 'Handicraft Icon', text: 'Handicraft' },
];
