  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center">
        ...
        <h2 className="font-spartan font-semibold text-2xl lg:text-3xl">
          {' '}
          Team Mentors
        </h2>
        <div className="w-full flex flex-wrap items-center justify-center mb-4">
          <MentorCard
            BlobImage={GreenBlobImage}
            teamMemberData={teamMembers[0]}
            cardClassName=""
            imgClassName="ms-12"
            textClassName="ms-8"
          />
          <MentorCard
            BlobImage={YellowBlobImage}
            teamMemberData={teamMembers[1]}
            cardClassName="pe-2"
            imgClassName=""
            textClassName=""
          />
          <MentorCard
            BlobImage={PurpleBlobImage}
            teamMemberData={teamMembers[2]}
            cardClassName="pe-6"
            imgClassName=""
            textClassName=""
          />
        ...
        <h2 className="font-spartan font-semibold text-2xl lg:text-3xl mb-6">
          Team Members
        </h2>
        <div className="w-full flex flex-row flex-wrap items-center justify-center gap-10 mb-10">
          {teamMembers
            ...
            .map((member) => (
              <MemberCard teamMemberData={member} />
            ))}
        </div>
        <div className="w-full flex flex-row flex-wrap items-center justify-center gap-10 mb-10">
          {teamMembers
