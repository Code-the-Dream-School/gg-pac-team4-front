...
const LoginForm = ({ onSubmit, formErrors, formData, handleChange, onRequestPasswordResetForm }) => {
    return (
        <form className="w-2/3 md:w-1/2 lg:w-1/3 xl:w-3/12" onSubmit={onSubmit}>
            ...
            <button type="button" onClick={onRequestPasswordResetForm} className=" font-spartan text-black mt-2 mb-2">Forgot Password?</button>
