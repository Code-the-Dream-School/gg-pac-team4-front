...
const ProfileNav = () => {
  ...
  return (
    <nav className="relative flex flex-row my-4 gap-2 items-center">
      <Link to="dashboard"><div id="user-photo" className="h-6 w-6 md:h-10 md:w-10 rounded-full bg-lightGreen"></div></Link>
      <Link to="dashboard"><p className="font-spartan text-sm md:text-lg font-semibold">{userData.firstName} {userData.lastName.slice(0,1)}.</p></Link>
